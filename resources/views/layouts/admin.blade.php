        ...
        <div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
            ...
            <main class="m2 -p-8 w-full">
                <div>
                    ...
                    <div class="p-4 mb-4 text-sm text-green-700 bg-green-100 rounded-lg dark:bg-green-200 dark:text-green">
                        <span class="font-medium">{{session()->get('success')}}</span>
                    </div>
                    @endif
                    @if (session()->has('warning'))
                    <div class="p-4 mb-4 text-sm text-yellow-700 bg-yellow-100 rounded-lg dark:bg-yellow-200 dark:text-yellow">
