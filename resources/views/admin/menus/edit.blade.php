            ...
            <div class="m-2 py-2  bg-slate-100 rounded ">
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{ route('admin.menus.update',$menu->id)}}" enctype="multipart/form-data">
                        ...
                        <div class="sm:col-span-6">
                            <label for="price" class="block text-sm font-medium text-gray-700">prix consulation</label>
                            <div class="mt-1">
                                <input type="number" min="0.00" max="10000.000" step="0.001" id="price" name="price" value="{{$menu->price}}"
                                    class="block w-full transition">
                            </div>
                        </div>
                        <div class="sm:col-span-6 pt-5">
                            ...
                            <div class="mt-1">
                                <textarea id="body" rows="3" name="description"
                                   class="shadow-sm focus:ring-indigo-500 appearance-none block w-full transition">
                                {{$menu->description}}
                                </textarea>
                            </div>
                        </div>
