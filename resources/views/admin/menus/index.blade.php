        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-end m-2 p-2">
                <a href="{{ route('admin.menus.create') }}"
                    class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">cree type d'imgration</a>

            </div>

            <div class="flex flex-col">
                <div class="ouverflow-x-auto sm:-mx-6 lg:mx-8">
                                            ...
                                            <td
                                                ...
                                                <div class="flex space-x-2">
                                                    ...
                                                    <form
                                                        ...
                                                        onsubmit="retrun confirme('Voulez vous supprimer');">
                                                        @csrf
                                                        @method('DELETE')
